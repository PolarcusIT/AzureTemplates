...
If you would like to clone this respository, things to change are:
README.md - button links need to be updated to the location of the AzureDeploy.json in the new repository
AzureDeploy.parameters.json - baseURL needs to be updated to the location in the new repository
AzureDeploy.json - baseURL needs to be updated to the location in the new repository